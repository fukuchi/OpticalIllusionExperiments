class MullerLyer2Illusion implements Illusion {
  ...
  void draw(PGraphics pg) {
    ...
    pg.ellipse(endPoint1 - wingWidth, 0, wingWidth * 2, wingWidth * 2);
    pg.ellipse(endPoint2 + wingWidth, 0, wingWidth * 2, wingWidth * 2);
